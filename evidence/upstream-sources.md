...
- 千问办公：[官方网站](https://www.qianwen.com/)
- DuMate：[官方网站](https://www.dumate.cn/)
- 豆包工作：[官方网站](https://www.doubao.com/work)

这些链接只能证明平台入口。md2wechat 的验证状态由 [agent-platforms.json](agent-platforms.json) 记录；当前没有平台完成真实兼容性 smoke。
